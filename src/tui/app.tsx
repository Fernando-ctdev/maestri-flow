...
type TuiActions = Partial<Record<Exclude<ScreenId, "connect">, () => void | Promise<void>>> & { connect?: (config: WireConfig) => void | Promise<void> };
