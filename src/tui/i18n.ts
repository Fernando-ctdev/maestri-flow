...
const en: UiText = {
  ...
  connection: { connected: "CONNECTED", loading: "CONNECTING", error: "ERROR", idle: "OFFLINE" }, workspace: "No workspace", floor: "ground", screensLabel: "SCREENS", loading: "Loading live state…", error: "Error", emptyCanvas: "No canvas snapshot yet.", bindings: count => `${count} binding(s)`, reviewReady: "Ready to save", reviewIssues: count => `${count} issue(s)`, shortcuts: "←/→ n/b navigate · 1–6 jump · q quit", nonInteractive: "maestri-flow configure (non-interactive; use a TTY for navigation)"
};
